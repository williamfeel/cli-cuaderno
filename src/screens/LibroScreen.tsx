...
import { createPDFLibro } from "../helper/createPdf";
...
export const LibroScreen = () => {
  ...
  const onSubmitBorrar = (transaccionId: number) => {
    ...
    setMessageModal("Transacción borrada ✌️")
  ...
  return (
    <FondoHoja>
      ...
      <Pressable
        ...
        onLongPress={() => { createPDFLibro({ clients, transacciones, setIsPosting }), setIsPosting(true) }}
        disabled={isPosting}
      >
